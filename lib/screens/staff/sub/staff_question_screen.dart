...
class StaffQuestionScreen extends StatefulWidget {
  const StaffQuestionScreen(): super();

  static const String ROUTE_ID = 'staff_question_screen';

  @override
  _StaffQuestionScreenState createState() => _StaffQuestionScreenState();
}
...
class _StaffQuestionScreenState extends State<StaffQuestionScreen> {
  ...
  Widget build(BuildContext context) {
    return VisibilityDetector(
      key: const Key(StaffQuestionScreen.ROUTE_ID),
