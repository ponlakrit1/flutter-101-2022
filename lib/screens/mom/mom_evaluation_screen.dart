...
class MomEvaluationScreen extends StatefulWidget {
  const MomEvaluationScreen(): super();

  static const String ROUTE_ID = 'mom_evaluation_screen';

  @override
  _MomEvaluationScreenState createState() => _MomEvaluationScreenState();
}

class _MomEvaluationScreenState extends State<MomEvaluationScreen> {
  ...
  Widget build(BuildContext context) {
    return VisibilityDetector(
      key: const Key(MomEvaluationScreen.ROUTE_ID),
                        ...
                        children: [
                          ...
                          TextButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.of(context, rootNavigator: true).pushNamed(MomQuestionScreen.ROUTE_ID);
                            },
